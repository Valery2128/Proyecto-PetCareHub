...
<div class="card-header">
    <div class="row align-items-center">
        <div class="col">
            <h3 class="mb-0">Registrar seguimiento a condiciones como accidentes o enfermedades - {{$mascota->nombre}}</h3>
        </div>
...
<div class="card-body">
    <form action="{{url('registrarsalud')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    <label for="dateInput">Fecha del seguimiento<strong class="text-danger">*</strong></label>
        ...
        <div class="form-group">
            <label for="emailInput">Diagnostico<strong class="text-danger">*</strong></label>
        ...
        <div class="form-group">
            <label for="emailInput">Tratamiento<strong class="text-danger">*</strong></label>
            <textarea rows="3" class="form-control @error('description') is-invalid @enderror" name="description"
                      id="descriptionInput" resize="none">{{old('description')}}</textarea>
        </div>
        <div class="form-group">
            <label for="emailInput">Evolucion<strong class="text-danger">*</strong></label>
            <textarea rows="3" class="form-control @error('description') is-invalid @enderror" name="description"
                      id="descriptionInput" resize="none">{{old('description')}}</textarea>
        </div>
        <div class="row mx-auto">
            <button type="submit" class="btn btn-outline-success">Registrar seguimiento</button>
        </div>
